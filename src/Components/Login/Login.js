...
const Login = () => {
      const [signInWithGoogle, userForGoogle, googleLoading, googleError] = useSignInWithGoogle(auth);
      ...
      useEffect(() =>{
        ...
        if(googleError || emailPasswordError){
          errorForSingIn = <p className='text-red-500'>{googleError?.message || emailPasswordError?.message} </p>
        }
            ...
            <div className="card-body">
              <div className="card-body">
                 ...
                 <div className=' container text-center mt-3'>
                      <span className='text-xl mr-1'>New to Car Parts?</span>
                      <Link to="/register" className="link link-hover text-success text-xl">Create new account</Link>
                 </div>
