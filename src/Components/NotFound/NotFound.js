    ...
    return (
        <div>
           <div className='text-center text-3xl text-red-500 font-bold py-5'>
               ...
               <h1>Don`t Cry!</h1>
                        <button className="btn btn-success font-bold text-2xl mt-5 "><svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 mr-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
